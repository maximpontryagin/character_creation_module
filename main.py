...
def attack(char_name, char_class):  # comment
...
def special(char_name, char_class):
    # в зависимости от перс. возвр. сообщ. о применение спец. умения
    if char_class == 'warrior':
...
def start_training(char_name, char_class):  # Запускает цикл тренировки навыков
    if char_class == 'warrior':
...
def choice_char_class():
    # Выбор типа персонажа и возвращает выбранный вариант
    approve_choice = None
    char_class = None
